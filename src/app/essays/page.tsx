...
export default function EssaysPage() {
  ...
  useEffect(() => {
    try {
      ...
      setEssays(stored ? JSON.parse(stored) : [])
    } catch { /* ignore */ }
    setLoading(false)
  }, [])
  ...
  function getTypeLabel(type: string) {
    switch (type) {
      ...
      default: return { label: '📖 Apprise', color: '#4CAF82' }
    }
  }
      ...
      <div className="px-4 pt-12">
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-[#9A9BB0] text-sm mb-6">Génère ta première dissertation depuis l&apos;accueil</p>
            <Link href="/dashboard"
          ...
          <div className="space-y-3">
            {essays.map((essay) => {
              ...
              return (
                <div key={essay.id} className="bg-[#1E2030] rounded-xl border border-[rgba(255,255,255,0.07)] p-4">
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex-1 min-w-0">
                      <p className="text-sm text-[#F0F0F5] italic truncate mb-1"
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {essay.score && (
                          <span className="text-xs text-[#9A9BB0]">
                            · <span className="text-[#F5A623] font-medium">{essay.score}/100</span>
                          </span>
                        )}
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      ...
                      <button onClick={() => deleteEssay(essay.id)}
